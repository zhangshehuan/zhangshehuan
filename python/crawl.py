...
def crawl_web(url):
	...
	while tocrawl:
		...
		if entry not in crawled:
			...
			add_page_to_index(index, entry, content)
...
(index, graph), crawl_time = time_execution("crawl_web('http://udacity.com/cs101x/urank/index.html')")
...
print lucky_search(index, ranks, 'is')
